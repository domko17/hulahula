            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var div_dots = $('<div class="div_dots flex"></div>');

                        var div_meeting = $('<div class="div_meeting"></div>');
                        var div_free = $('<div class="div_free"></div>');
                        var div_taken = $('<div class="div_taken"></div>');
                        var div_past_class = $('<div class="div_past"></div>');

                        div_dots.append(div_meeting);
                        div_dots.append(div_free);
                        div_dots.append(div_taken);
                        div_dots.append(div_past_class);

                        $dayElement.append(div_dots);
