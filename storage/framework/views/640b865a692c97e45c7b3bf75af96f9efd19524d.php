...
<head>
    ...
    <link rel="apple-touch-startup-image" href="<?php echo e(asset('images/app/hula_hula_sq.png')); ?>">
    ...
    <?php if(!request()->is('login') and !request()->is('register') and
         !request()->is('password/reset') and !request()->is('password/reset/*') and
         !isset($exception) and !request()->is('no_conn')): ?>
        <?php if(Auth::user() and Auth::user()->theme == 2): ?>
            <link href="<?php echo e(asset('css/style_dark.css')); ?>" rel="stylesheet">
        <?php else: ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("vendors/iconfonts/font-awesome/css/font-awesome.min.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(asset("vendors/iconfonts/ti-icons/css/themify-icons.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(asset("vendors/iconfonts/flag-icon-css/css/flag-icon.min.css")); ?>">
...
<?php if(!request()->is('login') and !request()->is('register') and
    ...
    <div class="container-scroller">
        <?php if(!request()->is('login') and !request()->is('register') and
             !request()->is('password/reset') and !request()->is('password/reset/*') and
             !isset($exception) and !request()->is('no_conn') and !request()->is('thank-you')): ?>
            <?php echo $__env->make("layouts.components.top_navigation", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
            ...
            <div class="main-panel">
                <div class="content-wrapper p-3 pl-md-5 pr-md-5 pb-md-5 pt-md-3">
                    ...
                    <div class="alert alert-info">
                        Aplikácia je vo verzii <b>&beta; <?php echo e(env('APP_VERSION')); ?></b><br>
                    ...
                    <footer class="footer">
                        <div class="d-sm-flex justify-content-center justify-content-sm-between">
                            ...
                            Verzia <?php echo e(env('APP_VERSION')); ?> | Made by <a
...
<script src="<?php echo e(asset('js/enable-push.js')); ?>"></script>
...
<script>
    ...
    $(document).ready(function () {
            <?php if(session()->has('message') and session()->has('msg_type')): ?>
        let type = "<?php echo e(session()->get('msg_type')); ?>";
        let msg = "<?php echo e(session()->get('message')); ?>";
        let icon = "success";
        let status = "Success";
        let colorbg = "#adf09e";
        let colorld = "#51b947";
        ...
        $("#register_form").validate({
            ...
            messages: {
                name: {
                    required: "<?php echo app('translator')->get('validation.required',["attribute"=>__('general.Name_surname')]); ?>"
                },
                email: {
                    required: "<?php echo app('translator')->get('validation.required',["attribute"=>__('general.email')]); ?>",
                },
                password: {
                    required: "<?php echo app('translator')->get('validation.required',["attribute"=>__('general.password')]); ?>",
                    minlength: "<?php echo app('translator')->get('validation.min.string', ["attribute"=>__('general.password'), "min"=>"8"]); ?>"
                },
                password_confirmation: {
                    required: "<?php echo app('translator')->get('validation.required',["attribute"=>__('general.Password_confirm')]); ?>",
