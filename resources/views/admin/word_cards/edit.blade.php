        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb px-1 px-md-3">
                ...
                <li class="breadcrumb-item active">
                    {{ $word->language->name_en }} - @lang('general.editing') ({{$word->id}})
                </li>
            </ul>
        </nav>
    </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route("admin.word_cards.update", $word->id) }}" id="form_create_card">
                        @csrf
                        @method("PUT")

                        <input type="hidden" name="language_id" value="{{ $word->language->id }}">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-4">
                                <select name="word_diff" id="word_diff" class="form-control" required>
                                    ...
                                    <option value="1" {{ $word->language_level == 1 ? "selected" : "" }}>A1</option>
                                    <option value="2" {{ $word->language_level == 2 ? "selected" : "" }}>A2</option>
                                    <option value="3" {{ $word->language_level == 3 ? "selected" : "" }}>B1</option>
                                    <option value="4" {{ $word->language_level == 4 ? "selected" : "" }}>B2</option>
                                    <option value="5" {{ $word->language_level == 5 ? "selected" : "" }}>C1</option>
                                </select>
                            </div>
                        </div>
