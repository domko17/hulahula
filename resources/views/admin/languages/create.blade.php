...
@section('content')
    <div class="page-header mt-2 mb-2 mb-mt-4 mt-md-0">
        ...
        <h3 class="page-title">
            <button onclick="window.location.href='{{ route('dashboard') }}'" class="page-title-icon btn btn-gradient-primary btn-icon btn-rounded btn-sm">
                <i class="mdi mdi-home"></i>
            </button> <a href="{{ route('dashboard') }}" class="text-dark"></a>
        </h3>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('language.language_create')</h4>
                    <p class="card-description">@lang('language.language_create_help')</p>

                    <form method="POST" action="{{ route('admin.languages.store') }}" id="form_language_create">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="name_native" name="name_native" value="" minlength="2"
                                       class="form-control"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="name_en"
                                   class="col-sm-4 col-form-label text-right">@lang('language.name_en')<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" id="name_en" name="name_en" value="" minlength="2"
                                       class="form-control"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="name_sk"
                                   class="col-sm-4 col-form-label text-right">@lang('language.name_sk')<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" id="name_sk" name="name_sk" value="" minlength="2"
                                       class="form-control"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="abbr"
                                   class="col-sm-4 col-form-label text-right">@lang('language.abbreviation')<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" id="abbr" name="abbr" value="" minlength="2" maxlength="4"
                                       class="form-control"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <button class="btn btn-inverse-dark btn-sm" role="iconpicker" data-iconset="flagicon"
                                        data-search-text="sk" data-icon="flag-icon-sk" name="icon" id="icon"></button>
                            </div>
                        </div>
