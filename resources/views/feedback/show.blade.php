            ...
            <div class="row">
                <div class="col-12 text-center">
                    <h3>@lang('feedback.lecture_feedback'):<br>
                        <a href="{{ route('user.profile', $teacher->id) }}" class="text-primary">
                            {{ $teacher->name }}
                        </a></h3>
                </div>
                <div class="col-12 text-center">
                    <img alt src="{{ $teacher->profile->getProfileImage() }}" class="rounded-circle"
                         style="max-width: 125px; width: 100%">
                </div>
                <div class="col-12 mt-4 text-center">
                    <h3>@lang('feedback.feedback_from'):<br>
                        <a href="{{ route('user.profile', $student->id) }}" class="text-primary">
                            {{ $student->name }}
                        </a></h3>
                </div>
                <div class="col-12 text-center">
                    <img alt src="{{ $student->profile->getProfileImage() }}" class="rounded-circle"
                         style="max-width: 125px; width: 100%">
                </div>
            </div>
        </div>
